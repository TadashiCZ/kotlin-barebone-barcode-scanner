...
class CameraSource(val preview: CameraSourcePreview) {
    ...
    private fun setPreviewAndPictureSize(camera: Camera, parameters: Parameters) {
        val sizePair: CameraSizePair = run {
            ...
            val displayAspectRatioInLandscape: Float =
                if (Utils.isPortraitMode(preview.context)) {
    ...
    private fun setRotation(camera: Camera, parameters: Parameters) {
        val windowManager = preview.context.getSystemService(Context.WINDOW_SERVICE) as WindowManager
